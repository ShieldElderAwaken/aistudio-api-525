...
```bash
git clone https://github.com/ShieldElderAwaken/aistudio-api-525.git
cd aistudio-api-525
python setup.py
```
...
# 克隆项目
git clone https://github.com/ShieldElderAwaken/aistudio-api-525
cd aistudio-api
...
<!-- Last updated: 2026-06-06 17:27:39 -->
